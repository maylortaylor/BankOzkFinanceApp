...
namespace App.IdentityServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "Identity Server", Version = "v1" });
                ...
                options.AddSecurityDefinition("oauth2", new OAuth2Scheme
                {
                    ...
                    Scopes = new Dictionary<string, string> {
                        { "id_server", "Identity Server - full access" }
                    }
                });
            });
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.OAuthClientId("id_server_swagger");
                options.OAuthAppName("Identity Server - Swagger");
            });
